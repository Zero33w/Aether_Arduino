...
// ----------------------------------------------------
// char,int,int ->  stringAUint8AlReves() -> int
// ----------------------------------------------------
...
public:
  ...
  public:
    // ---------------------------------------------------------
    // int,SecureMode_t,SecureMode_t,int -> asignarPropiedadesPermisosYTamanyoDatos()
    // ---------------------------------------------------------
